...
class GDUiSettings {
  ...
  constructor(init = null) {
    ...
    this.unknown4_ =
      (init && init.unknown4 != null) ? init.unknown4 : ['', '', '', '', ''];
    this.unknown5_ =
      (init && init.unknown5 != null) ? init.unknown5 : ['', '', '', '', ''];
    this.unknown6_ =
      (init && init.unknown6 != null) ? init.unknown6 : [1, 0, 0, 0, 0];

    this.hotSlots_ =
      (init && init.hotSlots != null) ? init.hotSlots : new Array(46);
    ...
    this.cameraDistance_ =
      (init && init.cameraDistance != null) ? init.cameraDistance : 36;
  }
};
