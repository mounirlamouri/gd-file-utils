...
class GDItem {
  ...
  constructor(init = null) {
    ...
    this.modifierName_ =
      (init && init.modifierName != null) ? init.modifierName : '';

    /** Name of the transmute, if any. */
    this.transmuteName_ =
      (init && init.transmuteName != null) ? init.transmuteName : '';
    ...
    this.componentName_ =
      (init && init.componentName != null) ? init.componentName : '';
    ...
    /** TODO: random seed? */
    this.componentSeed_ =
      (init && init.componentSeed != null) ? init.componentSeed : 0;

    /** TODO */
    this.augmentName_ =
      (init && init.augmentName != null) ? init.augmentName : '';
    ...
    /** TODO: random seed? */
    this.augmentSeed_ =
      (init && init.augmentSeed != null) ? init.augmentSeed : 0;
