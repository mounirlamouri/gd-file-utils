 ...
 */
 class GDSkill {
  constructor(init = null) {
    this.name_ = (init && init.name != null) ? init.name : "records/skills/default/default";
    this.level_ = (init && init.level != null) ? init.level : 1;
    this.enabled_ = (init && init.enabled != null) ? init.enabled : true;
    this.devotionLevel_ = (init && init.devotionLevel != null) ? init.devotionLevel : 0;
    ...
    this.autoCastSkill_ = (init && init.autoCastSkill != null) ? init.autoCastSkill : "";
    this.autoCastController_ = (init && init.autoCastController != null) ? init.autoCastController : "";
  }
}
